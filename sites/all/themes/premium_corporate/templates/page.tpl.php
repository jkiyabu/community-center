...
<div id="wrap" class="clearfix">
  ...
  <div id="slider-wrap">
    <div id="slider_nivo" class="nivoSlider">
      <img src="<?php print base_path() . drupal_get_path('theme', 'premium_corporate') . '/images/building2.jpg'; ?>" height="360" width="970" <?php if ($slide1_cap) { print 'title="#caption0"'; } ?> />
      <img src="<?php print base_path() . drupal_get_path('theme', 'premium_corporate') . '/images/children.jpg'; ?>" height="360" width="970" <?php if ($slide2_cap) { print 'title="#caption1"'; } ?> />
      <img src="<?php print base_path() . drupal_get_path('theme', 'premium_corporate') . '/images/court.jpg'; ?>" height="360" width="970" <?php if ($slide3_cap) { print 'title="#caption2"'; } ?> />
    </div>
